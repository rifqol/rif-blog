<x-dashboard>
    ...
    <div class="overflow-x w-full mt-3">
        <div my-6 mt-6 mb-6 ml-6>
            <a href="/dashboard/categories/create" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-6">Create New Category</a>
        </div>
        
        <table class="min-w-full max-w-md mt-6 bg-white">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="/dashboard/categories/{{ $category->slug }}" class="text-blue-600 hover:text-blue-900 inline-block">
                        ...
                        <a href="/dashboard/categories/{{ $category->slug }}/edit" class="text-yellow-600 hover:text-yellow-900 inline-block ml-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline-block" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <form action="/dashboard/categories/{{ $category->slug }}" method="POST" class="inline-block ml-2">
                            @method('DELETE')
                            @csrf
