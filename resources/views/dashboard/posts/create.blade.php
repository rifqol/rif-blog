          ...
          <div class="border-b border-gray-900/10 pb-12">
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-4">
                    ...
                    placeholder="Input your title" required autofocus value="{{ old('title') }}" @error('title') is-invalid @enderror>
                    @error('title')
                ...
                <div class="sm:col-span-4">
                    ...
                    <input type="text" name="slug" id="slug" autocomplete="slug" class="block flex-1 border-0 bg-white py-1.5 pl-1 text-gray-900 rounded placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="{{ old('slug') }}" readonly>
                </div>
